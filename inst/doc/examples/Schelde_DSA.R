...
outA <- as.data.frame(vode(state, times, DSAmodel, phPars, scenario="A", hmax=1))[-1,]
outB <- as.data.frame(vode(state, times, DSAmodel, phPars, scenario="B1", hmax=1))[-1,]
outC <- as.data.frame(vode(state, times, DSAmodel, phPars, scenario="C" , hmax=1))[-1,]
